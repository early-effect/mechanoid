...
```scala
// Core library
libraryDependencies += "rocks.earlyeffect" %% "mechanoid" % "0.3.2+15-e339bf45+20260727-1145"

// PostgreSQL persistence (optional)
libraryDependencies += "rocks.earlyeffect" %% "mechanoid-postgres" % "0.3.2+15-e339bf45+20260727-1145"
```
